...
<body>
    ...
    <div class="container px-10">
        <div class="p-10 text-center">
            <h1 class="text-4xl fw-bold text-primary">Our Story</h1>
        </div>
        ...
        <div class="d-flex justify-content-start mx-auto p-4 container flex-column flex-md-row gap-4">
            <div class="mx-auto d-flex flex-column gap-3">
                <h2 class="text-2xl fw-bold text-primary">History</h2>
        ...
        <div class="d-flex justify-content-center mx-auto py-4 gap-4 flex-wrap">
            ...
            <div class="d-flex flex-column align-items-center">
                <h1 class="text-2xl fw-bold text-primary">Mission</h1>
                <div class="rounded shadow-sm p-4 hover:shadow-lg">
        ...
        <div class="py-4">
            <div class="pb-4 text-center">
                <h1 class="text-2xl fw-bold text-primary">Bachelor of Arts in Broadcasting</h1>
            </div>
        ...
        <div class="d-flex justify-content-center mx-auto py-4 gap-4 flex-wrap">
            <div class="text-center">
                <h1 class="text-2xl fw-bold text-primary">Development Team</h1>
